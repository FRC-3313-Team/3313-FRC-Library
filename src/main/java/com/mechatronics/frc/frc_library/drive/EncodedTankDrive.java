...
public class EncodedTankDrive {
	...
	public EncodedTankDrive(Spark left, Spark right, Encoder leftEncod, Encoder rightEncod, GyroBase gyro) {
		this.gyro = gyro;
		this.leftMotor = left;
	 ...
	 *
	 * @param degrees How much to turn by. Positive values are clockwise; negative
	 *                are anti-clockwise
	 ...
	 * 
	 * @param angleAttempted The angle that was attempted to be reached
